...
function App() {
  ...
  const deleteTodo = async id => {
    try {
      await fetch("http://localhost:8000/todos/".concat(id, "/"), {
        method: 'DELETE',
        headers: {
          'Content-Type': 'application/json'
        }
  ...
  const moveToCompleted = async id => {
    try {
      ...
      const response = await fetch("http://localhost:8000/todos/".concat(id, "/"), {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json'
        },
...
/******/ })()
;
//# sourceMappingURL=App.5313072022ef5465beadc3966821c0ef.js.map